...
public class pnlImage extends javax.swing.JPanel {
    ...
    public pnlImage(clsCharacter c, String id, String name) {
        itemIdentifier = id;
        character = c;
        initComponents();
        szName = name;
    ...
    public void LoadData() {
        ...
        if (o.getClass().equals(ImageIcon.class)) {
            lblImage.setText("");
            ImageIcon i = clsEngine.RescaleImageIcon((ImageIcon) o, ImageMaxWidth, ImageMaxHeight);
            lblImage.setIcon(i);
            if (clsEngine.boolResize) {
    ...
    private void lblImageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblImageMouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            if (evt.isControlDown()) {
                ...
                if (clsEngine.boolResize) {
                    i = clsEngine.RescaleImageIcon(i, ImageMaxWidth, ImageMaxHeight);
                }
