 ...
 * @author Erik
 */
public class frmExtended extends javax.swing.JFrame {
     ...
     */
    public frmExtended(clsCharacter c, String id, String[] data, String name) {
    ...
    public boolean LoadData() {
        ...
        jTableModel.clear();
        clsExtendedSheetData esd = (clsExtendedSheetData) characterHandle.extData.get(identifier);
        if (esd == null) {
            return true;
        }

        if (esd.Properties.length != esd.Values.length) {
            JOptionPane.showMessageDialog(null, "Error, corrupt/missing data in extended sheet.", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
