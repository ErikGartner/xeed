 ...
 * @author Erik
 */
public class pnlGenealogyGraph extends javax.swing.JPanel {
    ...
    public pnlGenealogyGraph() {
        initComponents();
    }

    public void InitiateGraph(clsCharacter[] cs, clsTemplate[] templates, Color[] colors, String[] picture_keys, String[] extra_keys) {
        ...
        for (int x = 0; x < cs.length; x++) {
            ...
            for (int y = 0; y < templates.length; y++) {
                ...
                if (cs[x].templateIdentifier.equals(templates[y].GetTemplateID())) {
                    ...
                    ImageIcon img = clsEngine.RescaleImageIcon((ImageIcon) cs[x].imgData.get(picture_keys[y]), ImageMaxSize, ImageMaxSize);
    ...
    private void createTree() {
        ...
        for (int x = 0; x < characters.length; x++) {
            ...
            clsCharacter c = characters[x].character;
    ...
    class CharacterNode {
        ...
        public CharacterNode(clsCharacter c) {
            this.character = c;
        }
