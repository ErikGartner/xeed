...
public class pnlSearch extends javax.swing.JPanel {
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            clsEngine.hwndMain.RemoveSearchField();
            return;
        }

        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {

            clsCharacter[] cs = clsEngine.hwndMain.GetSelectedCharacters();
            if (cs == null) {
                return;
            }
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (txtSearchString.isEmpty()) {
            clsEngine.hwndMain.SetSelectedCharacters(null);
            return;
        }

        clsEngine.hwndMain.SelectCharactersByStringSearch(txtSearchString, chkAll.isSelected());
