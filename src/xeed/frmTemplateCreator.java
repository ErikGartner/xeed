 ...
 * @author Erik
 */
public class frmTemplateCreator extends javax.swing.JFrame {
    ...
    public frmTemplateCreator() {
        ...
        treeOverview.setCellRenderer(new CustomRenderer(new javax.swing.ImageIcon(getClass().getResource("/application_xp.png")), new javax.swing.ImageIcon(getClass().getResource("/layout.png")), new javax.swing.ImageIcon(getClass().getResource("/brick.png"))));

    }

    public clsTemplate GenerateTemplate() {
    ...
    private boolean UploadTemplateToXEEDOnline(String szFile) {
        ...
        httpclient.getParams().setParameter(CoreProtocolPNames.USER_AGENT, "XEED v" + clsEngine.szVersion + " Build " + clsEngine.lngBuild + "." + clsEngine.GetXEEDCRC32());
        httpclient.getParams().setParameter(CoreProtocolPNames.PROTOCOL_VERSION, HttpVersion.HTTP_1_1);

        HttpPost httppost = new HttpPost(clsEngine.szTemplateUploadURL);
    ...
    private void initComponents() {
        ...
        chkSubmit.setToolTipText("Submit your template to the online database. Your template will manually be reviewed by the developement crew.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtGame, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnAddSectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSectionActionPerformed
        ...
        ti.szName = JOptionPane.showInputDialog(null, "Enter the name of the new section:", "Enter name", JOptionPane.PLAIN_MESSAGE);
        if (ti.szName == null) {
            return;
        }
    ...
    private void btnAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddItemActionPerformed
        ...
        if (selectedNode.isRoot()) {
            JOptionPane.showMessageDialog(null, "An item must be subsidiary to a section, please select a section or item to insert below.", "Invalid node selected!", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        frmTemplateItemPalett dp = new frmTemplateItemPalett(this, newNode, false);
        dp.setVisible(true);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        clsTemplate t = GenerateTemplate();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (txtTemplateName.getText().isEmpty() || txtGame.getText().isEmpty() || txtAuthor.getText().isEmpty() || txtDescription.getText().isEmpty()) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Version must be a valid integer and a postivive value greater than 0", "Invalid data", JOptionPane.WARNING_MESSAGE);
            return;
        }

        if (nameRow == null) {
            JOptionPane.showMessageDialog(null, "A template MUST contain 1 'Name Row'", "Missing data", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        clsTemplate t = GenerateTemplate();
        if (t.FinalizeTemplate(txtTemplateName.getText(), txtAuthor.getText(), txtGame.getText(), txtDescription.getText(), i)) {
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        clsEngine.hwndTemplateCreator = null;
        dispose();
    ...
    private void treeOverviewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_treeOverviewMouseClicked
        ...
        if (ti.intType == 0) {  //section
            ...
            String szName = JOptionPane.showInputDialog("Select the new name for the section '" + ti.szName + "'", ti.szName);
            if (szName != null) {
                if (!szName.isEmpty()) {
                    ti.szName = szName;
                }
            ...
            this.setEnabled(false);
            frmTemplateItemPalett dp = new frmTemplateItemPalett(this, selectedNode, true);
            dp.setVisible(true);
