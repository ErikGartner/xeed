...
public final class GraphForm extends javax.swing.JFrame {
   ...
   private void lblGenColorMouseClicked(java.awt.event.MouseEvent evt) {
      //GEN-FIRST:event_lblGenColorMouseClicked
      TemplateOption to = (TemplateOption) comboGenTemplate.getSelectedItem();
      if (to == null) {
         return;
      }
   ...
   private void comboGenPictureActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_comboGenPictureActionPerformed
   ...
   private void comboGenExtraActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_comboGenExtraActionPerformed
      if (reloading_template_options) {
         return;
      }
