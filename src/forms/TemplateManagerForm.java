...
public class TemplateManagerForm extends javax.swing.JFrame {
   ...
   private void mnuLoadActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuLoadActionPerformed
      if (tblTemplates.getSelectedRow() == -1) {
         return;
      }
   ...
   private void mnuLoadCustomActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuLoadCustomActionPerformed
      JFileChooser fc = new JFileChooser();
      fc.removeChoosableFileFilter(fc.getAcceptAllFileFilter());
      fc.addChoosableFileFilter(new FileNameExtensionFilter("xeed Template", "xdt"));
      fc.setFileSelectionMode(JFileChooser.FILES_ONLY);
   ...
   private void mnuDescriptionActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuDescriptionActionPerformed
      if (tblTemplates.getSelectedRow() == -1) {
         return;
      }
   ...
   private void tblTemplatesKeyPressed(java.awt.event.KeyEvent evt) {
      //GEN-FIRST:event_tblTemplatesKeyPressed
