...
public class MainForm extends javax.swing.JFrame implements ActionListener, ItemListener {
   ...
   private void initComponents() {
      ...
      mnuNewSetting.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,
      ...
      mnuLoadSetting.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L,
            java.awt.event.InputEvent.CTRL_MASK));
      ...
      mnuSaveSetting.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,
            java.awt.event.InputEvent.CTRL_MASK));
   ...
   private void tblCharactersMouseClicked(java.awt.event.MouseEvent evt) {
      //GEN-FIRST:event_tblCharactersMouseClicked
      if (evt.getButton() != 1) {
         return;
      }
   ...
   private void mnuOptionsActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuOptionsActionPerformed
   ...
   private void mnuExportCharsActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuExportCharsActionPerformed
      Character[] cs = GetSelectedCharacters();
      if (cs == null) {
   ...
   private void mnuDeleteCharacterActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuDeleteCharacterActionPerformed
      if (tblCharacters.getSelectedRowCount() == 0) {
         return;
      }
   ...
   private void mnuConverterActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_mnuConverterActionPerformed
      Character[] cs = GetSelectedCharacters();
      if (cs == null) {
