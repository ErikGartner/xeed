    ...
    private void txtDescriptionToKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescriptionToKeyReleased
        ...
        if (o1.getClass() == Character.class) {
            if (o2.getClass() == Character.class) {
                ...
                XEED.hwndNotifier.FireUpdate(affectedcharacters, false, false, false, false, false, false, false, true, false);
                ...
                affectedcharacters[0] = c1;
                XEED.hwndNotifier.FireUpdate(affectedcharacters, false, false, false, false, true, false, false, true, false);
