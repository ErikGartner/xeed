...
public class UpdateForm extends javax.swing.JFrame {
    ...
    private boolean UpdateXEED() {
        ...
        try {
            ...
            Process ps = Runtime.getRuntime().exec(new String[]{"java", "-jar", updater.getAbsolutePath(), URL, new File(MainForm.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getAbsolutePath()});
