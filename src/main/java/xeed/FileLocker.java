...
public class FileLocker {
    ...
    private Autosaver hwndAutoSaver = null;
    ...
    public FileLocker(String szP) {
        ...
        if (LockEnabled) {
            ...
            ClearFile();
            hwndAutoSaver = new Autosaver(this);
        }
    ...
    public Autosaver GetAutoSaverInstance() {
    ...
    public boolean AddSavePath(String szPath) {
        ...
        try {
            ...
            byte[] b = XEED.CreateElement(szPath, "save_path", false).getBytes("UTF-8");
    ...
    private String[] ReadSavePaths() {
        ...
        try {
            ...
            return XEED.GetElements(szBuffer, "save_path", false);
