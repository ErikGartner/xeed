 ...
 * @author Erik
 */
public class frmGroup extends javax.swing.JFrame implements TableModelListener {
    ...
    public pnlRelations relationsHandle = null;
    ...
    public void LoadRelationship() {
        ...
        clsGroup g = (clsGroup) comboGroup.getSelectedItem();
        if (g == null) {
            return;
        }

        relationsHandle = new pnlRelations(g);
    ...
    public final void RefreshData() {
        ...
        for (int x = 0; x < clsEngine.groupDB.size(); x++) {
            comboGroup.addItem(clsEngine.groupDB.get(x));
        }
    ...
    private void LoadMembers() {
        ...
        if (comboGroup.getSelectedItem() != null) {
            for (int x = 0; x < clsEngine.charDB.size(); x++) {
                ...
                clsGroup g = (clsGroup) comboGroup.getSelectedItem();
                if (g.IsMember(clsEngine.charDB.get(x).characterID)) {
                    o.add(true);
                } else {
                    o.add(false);
                }
                o.add(clsEngine.charDB.get(x));
                jTableModel.add(o);
            }
        }
    ...
    public void tableChanged(TableModelEvent e) {
        ...
        for (int x = 0; x < jTableModel.size(); x++) {
            ...
            clsCharacter c = (clsCharacter) o.get(1);
        ...
        clsEngine.hwndNotifier.FireUpdate(affectedcharacters, true, false, false, false, false, true, false, false, false);
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String szName = JOptionPane.showInputDialog(null, "Enter group name:", "Add new group", JOptionPane.PLAIN_MESSAGE);
        if (szName == null) {
            return;
        }
        ...
        g.szName = szName;
        g.lngID = clsEngine.CreateUniqueGroupID();
        ...
        clsCharacter[] affectedcharacters = new clsCharacter[clsEngine.charDB.size()];
        clsEngine.charDB.toArray(affectedcharacters);
        clsEngine.hwndNotifier.FireUpdate(affectedcharacters, true, false, true, false, false, false, true, false, false);
    ...
    private void btnRenameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRenameActionPerformed
        ...
        String szName = JOptionPane.showInputDialog(null, "Enter new group name:", "Rename " + g.szName, JOptionPane.PLAIN_MESSAGE);
        if (szName == null) {
            return;
        }
        ...
        clsCharacter[] affectedcharacters = new clsCharacter[clsEngine.charDB.size()];
        clsEngine.charDB.toArray(affectedcharacters);
        clsEngine.hwndNotifier.FireUpdate(affectedcharacters, true, false, true, false, false, true, true, false, false);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        for (int x = 0; x < clsEngine.charDB.size(); x++) {
            clsEngine.charDB.get(x).DeleteRelation(g.lngID, 1);
        }

        clsEngine.groupDB.remove(g);
        RefreshData();
        LoadRelationship();
    ...
    private void txtDescriptionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescriptionKeyReleased
        ...
        clsCharacter[] affectedcharacters = new clsCharacter[clsEngine.charDB.size()];
        clsEngine.charDB.toArray(affectedcharacters);
        clsEngine.hwndNotifier.FireUpdate(affectedcharacters, true, false, false, false, false, false, false, false, false);
