 ...
 * @author Erik
 */
public class frmRelations extends javax.swing.JFrame {
    ...
    public void LoadLists() {
        ...
        if (clsEngine.charDB.size() > 0) {
            ...
            for (int x = 0; x < clsEngine.charDB.size(); x++) {
                comboFrom.addItem(clsEngine.charDB.get(x));
            }
        }
        if (clsEngine.groupDB.size() > 0) {
            ...
            for (int x = 0; x < clsEngine.groupDB.size(); x++) {
                comboFrom.addItem(clsEngine.groupDB.get(x));
            }
        }
        ...
        if (clsEngine.charDB.size() > 0) {
            ...
            for (int x = 0; x < clsEngine.charDB.size(); x++) {
                comboTo.addItem(clsEngine.charDB.get(x));
            }
        }
        if (clsEngine.groupDB.size() > 0) {
            comboTo.addItem("");
            ...
            for (int x = 0; x < clsEngine.groupDB.size(); x++) {
                comboTo.addItem(clsEngine.groupDB.get(x));
            }
        }
    ...
    public void LoadRelationship() {
        ...
        if (o1.getClass() == clsCharacter.class) {
            if (o2.getClass() == clsCharacter.class) {

                clsCharacter c1 = (clsCharacter) o1;
                clsCharacter c2 = (clsCharacter) o2;
            ...
            } else if (o2.getClass() == clsGroup.class) {

                clsCharacter c1 = (clsCharacter) o1;
                clsGroup g2 = (clsGroup) o2;
        ...
        } else if (o1.getClass() == clsGroup.class) {
            if (o2.getClass() == clsCharacter.class) {

                clsGroup g1 = (clsGroup) o1;
                clsCharacter c2 = (clsCharacter) o2;
                lblTo.setText(c2.GetCharacterName());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(comboFrom, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblTo, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE))
                    .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(comboTo, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblFrom, javax.swing.GroupLayout.DEFAULT_SIZE, 128, Short.MAX_VALUE))
    ...
    private void txtDescriptionToKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescriptionToKeyReleased
        ...
        if (o1.getClass() == clsCharacter.class) {
            if (o2.getClass() == clsCharacter.class) {
                ...
                clsCharacter[] affectedcharacters = new clsCharacter[2];
                affectedcharacters[0] = c1;
                affectedcharacters[1] = c2;
                clsEngine.hwndNotifier.FireUpdate(affectedcharacters, false, false, false, false, false, false, false, true, false);
                ...
                affectedcharacters[0] = c1;
                clsEngine.hwndNotifier.FireUpdate(affectedcharacters, false, false, false, false, true, false, false, true, false);
            ...
            if (o2.getClass() == clsCharacter.class) {
                ...
                clsEngine.hwndNotifier.FireUpdate(null, false, false, false, false, true, false, false, true, false);
