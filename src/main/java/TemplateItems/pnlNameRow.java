 ...
 * @author Erik
 */
public class pnlNameRow extends javax.swing.JPanel {

    public clsCharacter character;
    public String itemIdentifier;

    public pnlNameRow(clsCharacter c, String id, String name) {
        itemIdentifier = id;
        character = c;
        initComponents();
    ...
    public void SaveData() {
        ...
        clsCharacter[] affectedcharacters = new clsCharacter[clsEngine.charDB.size()];
        clsEngine.charDB.toArray(affectedcharacters);
        clsEngine.hwndNotifier.FireUpdate(affectedcharacters, false, true, true, true, true, true, true, false, false);
