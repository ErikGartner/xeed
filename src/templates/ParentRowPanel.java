...
public class ParentRowPanel extends javax.swing.JPanel {
   ...
   private void comboListActionPerformed(java.awt.event.ActionEvent evt) {
      //GEN-FIRST:event_comboListActionPerformed
      if (!loaded || updating) {
         return;
      }
      ...
      if (o.getClass() == Character.class) {
         ...
         if (!_checkloop(familytree, (Character) o)) {
            JOptionPane
                  .showMessageDialog(
                        null,
                        "Invalid parent! The selected linage leads to an infinite loop (i.e. parents can't be children to their own children).",
