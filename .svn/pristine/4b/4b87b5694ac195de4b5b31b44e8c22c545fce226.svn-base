 ...
 * @author Erik
 */
public class pnlIntegerRowBC extends javax.swing.JPanel {

    public clsCharacter character;
    public String itemIdentifier;

    public pnlIntegerRowBC(clsCharacter c, String id, String name) {
        itemIdentifier = id;
        character = c;
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(comboADBC, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void validateInteger(JTextField txtField) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "The textfield '" + lblName.getText() + "' must contain an integer.", "Invalid data", JOptionPane.WARNING_MESSAGE);
            txtField.setText("");
        }
