...
public class frmOptions extends javax.swing.JFrame {
    ...
    public frmOptions() {
        ...
        chkBackup.setSelected(clsEngine.boolBackup);
        chkUpdate.setSelected(clsEngine.boolUpdate);
        tglbtnAssociate.setSelected(clsEngine.Associated);
        chkResizeImages.setSelected(clsEngine.boolResize);
        chkUseCustomRepository.setSelected(clsEngine.boolCustomRepository);
        txtRepository.setEnabled(clsEngine.boolCustomRepository);
        txtRepository.setText(clsEngine.szCustomReposityURL);
        chkUpdateToBeta.setSelected(clsEngine.boolUpdateToBeta);
        chkCustomTemplateFolder.setSelected(clsEngine.boolCustomTemplateFolder);
        if (clsEngine.boolCustomTemplateFolder) {
            txtCustomTemplateFolder.setText(clsEngine.szTemplateFolder);
        }

        if (clsEngine.Associated) {
            chkReassociate.setSelected(clsEngine.ReAssociate);
    ...
    private void initComponents() {
        ...
        chkReassociate.setToolTipText("The file association is updated each time XEED is started. This is normally not needed.");
        ...
        chkUseCustomRepository.setToolTipText("If yes, XEED will not check for templates from the official source but rather an alterative one.");
        ...
        chkResizeImages.setToolTipText("If no, then XEED will save images in character sheets in their origianl size and resize on the fly. This is good if you intend to export images from xeed. However saving and loading will be slower.");
        ...
        chkCustomTemplateFolder.setToolTipText("If checked you will be able to change the template folder. The default one is \\Templates\\");
            ...
            txtCustomTemplateFolder.setToolTipText("The path to the folder were downloaded templates will be saved and XEED will also detect the templates in the folder automaticly.");
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtCustomTemplateFolder, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtRepository))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(lblCheckRepository)))
                    .addContainerGap())
            );
            jPanel1Layout.setVerticalGroup(
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(lblCheckRepository, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(chkCustomTemplateFolder)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(txtCustomTemplateFolder, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            chkUpdateToBeta.setToolTipText("Update to the latest version even if it is a beta, i.e. an unfinished testing version.");
                ...
                .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(chkUpdateToBeta, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void tglbtnAssociateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tglbtnAssociateActionPerformed
        ...
        if (!os.toLowerCase().contains("windows")) {
            JOptionPane.showMessageDialog(null, "The file association feature only works on windows.", "Unsupported platform!", JOptionPane.WARNING_MESSAGE);
            tglbtnAssociate.setSelected(false);
            return;
        }

        if (tglbtnAssociate.isSelected()) {
            int intRet = JOptionPane.showOptionDialog(null, "Creating a file association will make the .xdf files runnable.\nHowever they will be associated with this xeed file. If it moved or deleted the association will be invalid.\nPrevious .xdf associations will be overwritten.\nDo you want to proceed?", "Associate with .xdf?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
            if (intRet == 0) {
                if (!clsEngine.UpdateAssociation(true)) {
                    tglbtnAssociate.setSelected(false);
            ...
            clsEngine.UpdateAssociation(false);
            chkReassociate.setSelected(false);
            chkReassociate.setEnabled(false);
        }

        clsEngine.Associated = tglbtnAssociate.isSelected();
    ...
    private void chkUseCustomRepositoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkUseCustomRepositoryActionPerformed
        clsEngine.boolCustomRepository = chkUseCustomRepository.isSelected();
        if (clsEngine.boolCustomRepository) {
            txtRepository.setEnabled(true);
        } else {
            txtRepository.setEnabled(false);
            txtRepository.setText("");
            clsEngine.szCustomReposityURL = "";
        }
    ...
    private void chkReassociateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkReassociateActionPerformed
        clsEngine.ReAssociate = chkReassociate.isSelected();
    ...
    private void chkBackupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkBackupActionPerformed
        clsEngine.boolBackup = chkBackup.isSelected();
    ...
    private void chkResizeImagesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkResizeImagesActionPerformed
        clsEngine.boolResize = chkResizeImages.isSelected();
        if (!clsEngine.boolResize) {
            JOptionPane.showMessageDialog(null, "Warning! Saving large images in XEED makes loading and saving slower and may lead to unexpected consequences.\nTo reiterate, it is HIGHLY recommended that you leave it checked.", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void chkUpdateToBetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkUpdateToBetaActionPerformed
        clsEngine.boolUpdateToBeta = chkUpdateToBeta.isSelected();
    ...
    private void txtRepositoryKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRepositoryKeyReleased
        if (clsEngine.boolCustomRepository) {
            clsEngine.szCustomReposityURL = txtRepository.getText();
        }
    ...
    private void txtRepositoryFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtRepositoryFocusLost
        if (clsEngine.TestRepository(txtRepository.getText())) {
    ...
    private void chkCustomTemplateFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkCustomTemplateFolderActionPerformed
        ...
        clsEngine.boolCustomTemplateFolder = chkCustomTemplateFolder.isSelected();
        if (clsEngine.boolCustomTemplateFolder) {
            txtCustomTemplateFolder.setEnabled(true);
        } else {
            txtCustomTemplateFolder.setEnabled(false);
            txtCustomTemplateFolder.setText("");
            clsEngine.szTemplateFolder = clsEngine.GetCurrentDirectory() + File.separator + "Templates";
        }
    ...
    private void txtCustomTemplateFolderKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomTemplateFolderKeyReleased
        if (clsEngine.boolCustomTemplateFolder) {
            clsEngine.szTemplateFolder = txtCustomTemplateFolder.getText();
        }
