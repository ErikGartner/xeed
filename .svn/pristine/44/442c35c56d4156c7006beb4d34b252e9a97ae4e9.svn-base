...
public class frmAbout extends JFrame {
    ...
    public frmAbout() {
        ...
        jLabel3.setText(clsEngine.szHomePage);
        jLabel5.setText(clsEngine.szVersion);
        jLabel7.setText(Long.toString(clsEngine.lngBuild) + "." + clsEngine.GetXEEDCRC32());
        jLabel9.setText(clsEngine.szCompiledOn);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        clsEngine.ExecuteLink(clsEngine.szHomePage);
    ...
    class CreditsRoller extends TimerTask {
        ...
        private frmAbout A = null;
        private int x = 0;

        public CreditsRoller(frmAbout a) {
            A = a;
        }

        public void run() {

            if (x >= clsEngine.szCredits.length) {
                x = 0;
            }

            A.jLabel12.setText(clsEngine.szCredits[x]);
            A.jLabel12.repaint();
            x++;
        }
    }
